    ...
    <div class="login-card" style="background: white; padding: 3rem; border-radius: var(--radius); box-shadow: var(--shadow-md); width: 100%; max-width: 450px;">
        ...
        <form action="<?= base_url('auth/create') ?>" method="post">
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="email" name="email" required placeholder="email@ejemplo.com" style="width: 100%; padding: 0.8rem 1rem; border: 1px solid #ddd; border-radius: 8px; outline: none;">
            </div>
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <textarea name="address" required placeholder="Copie y pegue aquí la dirección completa (Calle, Número, Referencias, Link de Maps...)" style="width: 100%; padding: 0.8rem 1rem; border: 1px solid #ddd; border-radius: 8px; outline: none; min-height: 80px; font-family: inherit;"></textarea>
                <p style="font-size: 0.85rem; color: var(--text-light); margin-top: 0.5rem;">Puede incluir múltiples direcciones o detalles específicos.</p>
            </div>
