...
<!-- Sección de Promoción del Kiosko -->
...
<!-- Sección de vista previa de reseñas -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function startAutoPlay() {
            ...
            autoPlayInterval = setInterval(moveNext, 3000); // 3 segundos
        }
